...
- [Directus SDK Client](directus-sdk-client.product.md) -- cung cấp `withToken` để thêm token vào request preview
- [Directus Visual Editor](visual-editing.product.md) -- live preview của Visual Editor dùng chung cơ chế này
